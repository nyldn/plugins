...
|---|---|---|
| Octopus | `claude plugin install octo@nyldn-plugins` or Codex `/plugins` as `octo` | Multi-LLM orchestration for Claude Code and Codex, with first-class `/octo:council`, agent summaries, prompt-size preflight, and research fanout. |
